...
#define EXAMPLE_ESP_WIFI_SSID      "Yaya"
...
static void lvgl_init_display_panel(void)
{
...
void wifi_init_softap(void)
{
    ...
    ESP_LOGI(TAG, "wifi_init_softap finished. SSID:\e[93m%s\e[92m password:\e[93m%s\e[92m channel:%d",
...
void app_main(void)
{
    ...
    lv_textarea_set_placeholder_text(ui_SSIDInput, EXAMPLE_ESP_WIFI_SSID);
    lv_textarea_set_placeholder_text(ui_PasswordInput, EXAMPLE_ESP_WIFI_PASS);
}
